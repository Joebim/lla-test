...
const SupportContainer = () => {
  return (
    <>
      <div className="flex w-full flex-col items-stretch justify-stretch gap-[20px]">
        <SettingsCard title="Submit a Request">
          <div className="flex flex-[10] flex-col gap-[20px]">
            <CustomInput
